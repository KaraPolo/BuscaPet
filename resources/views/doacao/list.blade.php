    ...
    <div class="carousel-item active">
      <div style="position: relative;">
        ...
        <div class="carousel-caption d-none d-md-block" style="z-index: 2;">
          ...
          <p>Página dedicada ao cadastro de animais que estão para adoção.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-3 d-flex justify-content-center">
      <div class="card custom-card" style="width: 200px; height: 100px;">
        <div class="card-body text-center">
          ...
          <p class="card-text custom-card-text">1º cadastre o pet que está para adoção</p>
        </div>
      </div>
    </div>
    <div class="col-3 d-flex justify-content-center">
      <div class="card custom-card" style="width: 200px; height: 100px;">
        <div class="card-body text-center">
          <img src="https://images.vexels.com/content/144068/preview/cookie-bone-b94361.png" alt="Ícone" style="width: 30px; height: 30px;" class="mr-2">
          <p class="card-text custom-card-text">2º outras pessoas interessadas o verão</p>
        </div>
      </div>
    </div>
    <div class="col-3 d-flex justify-content-center">
      <div class="card custom-card" style="width: 200px; height: 100px;">
        <div class="card-body text-center">
          <img src="https://images.vexels.com/content/144068/preview/cookie-bone-b94361.png" alt="Ícone" style="width: 30px; height: 30px;" class="mr-2">
          <p class="card-text custom-card-text">3º pronto, você deu um novo lar ao pet</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="container mt-4" style="background-color: #f59342; padding: 20px; border-radius: 8px;">
  <form action="{{ route('doacao.search') }}" method="post">
      <div class="row">
          @csrf
          <div class="col-4">
          ...
          <div class="col-6" style="margin-top: 22px;">
              ...
              <a href="{{ url('doacao/create') }}" class="btn custom-btn"><i class="fa-solid fa-plus"></i> Novo</a>
              <a href="{{ url('doacao/report') }}" class="btn custom-btn"><i class="fa-solid fa-file-pdf"></i> PDF</a>
          </div>
      </div>
  </form>
    ...
    <div class="col-md-4 mb-3">
      <div class="card" style="width: 100%; height: 800px;">
        ...
        <div class="card-body">
          ...
          <p class="card-text"><strong>Sexo do Animal:</strong> {{ $item->sexo }}</p>
          <p class="card-text"><strong>Características do Animal:</strong> {{ $item->caracteristicas }}</p>
          <p class="card-text"><strong>História do Animal:</strong> {{ $item->historia }}</p>
          <p class="card-text"><strong>Saúde e Esterilização:</strong> {{ $item->saude }}</p>
          <p class="card-text"><strong>Observações:</strong> {{ $item->observacao }}</p>
          ...
          <a href="{{ route('doacao.edit', $item->id) }}" class="btn btn-outline-primary" title="Editar"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
          <form action="{{ route('doacao.destroy', $item) }}" method="post" style="display: inline;">
            @method('DELETE')
            @csrf
